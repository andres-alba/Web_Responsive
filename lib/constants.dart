...
const kInformeColor = TextStyle(fontSize: 16.0, color: Color(0xff6E768E));

const kBigBlueNumber = TextStyle(
    fontSize: 46.0, color: Color(0xff001A72), fontWeight: FontWeight.bold);

const kBigGreyNumber = TextStyle(
    fontSize: 46.0, color: Colors.blueGrey, fontWeight: FontWeight.bold);

const kBigGreenNumber = TextStyle(
...
const kBlueText = TextStyle(
    fontSize: 25.0, color: Color(0xff001A72), fontWeight: FontWeight.bold);
